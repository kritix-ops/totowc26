...
export default async function AdminScoringSettingsPage({
  ...
  const [[cfg], prize] = await Promise.all([
    db
      .select({
        ...
        scoringAdvance: settings.scoringAdvance,
        ...
        maxOverdraft: settings.maxOverdraft,
        lockBetsWhenNegative: settings.lockBetsWhenNegative,
        ...
        liveOddsMinStake: settings.liveOddsMinStake,
        liveOddsMaxStake: settings.liveOddsMaxStake,
  ...
  const initial = {
    ...
    scoringAdvance: cfg?.scoringAdvance ?? 10,
    ...
    maxOverdraft: cfg?.maxOverdraft ?? 30,
    lockBetsWhenNegative: cfg?.lockBetsWhenNegative ?? true,
    ...
    liveOddsMinStake: cfg?.liveOddsMinStake ?? 1,
    liveOddsMaxStake: cfg?.liveOddsMaxStake ?? 30,
    liveOddsMaxPayoutRatio: cfg?.liveOddsMaxPayoutRatio ?? 8,
    liveOddsMaxPayoutCeiling: cfg?.liveOddsMaxPayoutCeiling ?? 100,
